...
const TokenomicsSection = () => {
  ...
  const vestingSchedule = [
    { stage: "TGE", presale: 25, team: 0, marketing: 50 },
    { stage: "Month 1", presale: 25, team: 0, marketing: 25 },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {tokenMetrics.map((metric, index) => (
            <Card key={metric.title} className="gradient-border bg-gradient-card text-center animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
              ...
              <div className="h-80 mb-6">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={vestingSchedule}>
                    ...
                    <Bar dataKey="presale" stackId="a" fill="#8b5cf6" radius={[0, 0, 0, 0]} />
                    <Bar dataKey="team" stackId="a" fill="#06b6d4" radius={[0, 0, 0, 0]} />
                    <Bar dataKey="marketing" stackId="a" fill="#10b981" radius={[2, 2, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
