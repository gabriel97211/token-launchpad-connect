...
const PresaleWidget = () => {
  ...
  const paymentMethods = [
    ...
    { symbol: "USDC", name: "USD Coin", icon: "$", price: 0.05 },
    { symbol: "USDT", name: "Tether", icon: "$", price: 0.05 },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Secure Your <span className="text-gradient">Tokens</span> Now
            </h2>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {paymentMethods.map((method) => (
                          ...
                          >
                            <div className="font-bold text-lg">{method.icon}</div>
                            <div className="text-sm">{method.symbol}</div>
                          </button>
                        ))}
                      </div>
                    </div>
