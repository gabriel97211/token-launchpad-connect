    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <Badge variant="secondary" className="mb-6 px-6 py-2 text-sm font-medium glow-accent animate-pulse-glow">
            ...
            <div className="flex justify-center space-x-4 md:space-x-6">
              {[
                ...
                <div key={item.label} className="text-center">
                  <div className="bg-card border border-border rounded-xl p-4 md:p-6 shadow-card glow-primary min-w-[80px] md:min-w-[100px]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-up" style={{animationDelay: '0.4s'}}>
            <Button 
              size="lg" 
              className="bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 text-lg px-8 py-6 glow-primary animate-glow"
            >
              Join Presale Now
            </Button>
            <Button 
              variant="outline" 
              size="lg"
              className="gradient-border text-lg px-8 py-6"
            >
              View Whitepaper
            </Button>
          </div>
